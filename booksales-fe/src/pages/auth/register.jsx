...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error?.response?.data?.message || "Gagal registrasi");
    } finally {
      setLoading(false);
    }
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="terms" className="ml-3 text-sm font-light text-gray-500 dark:text-gray-300">
                  I accept the{" "}
                  <Link to="/" className="font-medium text-indigo-600 hover:underline dark:text-indigo-500">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:opacity-50"
              >
