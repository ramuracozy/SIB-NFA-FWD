                ...
                {authors.length > 0 ? (
                  authors.map((author) => (
                    <tr key={author.id} className="border-b dark:border-gray-700">
                      ...
                      <td className="px-4 py-3">{author.photo}</td> {/* Ubah menjadi teks nama file saja */}
                      <td className="px-4 py-3">{author.bio.substring(0, 100)}...</td>
                  ...
                  <p>Data author tidak ditemukan</p>
                )}
              </tbody>
            </table>
          </div>
